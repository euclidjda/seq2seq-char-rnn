...
tf.app.flags.DEFINE_integer("en_vocab_size", 7000, "English vocabulary size.")
tf.app.flags.DEFINE_integer("fr_vocab_size", 7000, "French vocabulary size.")
...
_buckets = [(10, 12), (20, 22), (40, 42), (50, 52)]
...
def create_model(session, forward_only):
  ...
  model = seq2seq_model.Seq2SeqModel(
    ...
    keep_prob=keep_prob,forward_only=forward_only,max_to_keep=100000)
  ...
  with tf.Session() as sess:
    ...
    while True:
      ...
      if current_step % FLAGS.steps_per_checkpoint == 0:
        ...
        checkpoint_path = os.path.join(FLAGS.train_dir, "translate.%04d.ckpt"%ckpt_cnt )
...
def decode():
  with tf.Session() as sess:
    ...
    en_vocab_path = os.path.join(FLAGS.data_dir,
                                 "vocab%d.to" % FLAGS.en_vocab_size)
    fr_vocab_path = os.path.join(FLAGS.data_dir,
                                 "vocab%d.fm" % FLAGS.fr_vocab_size)
